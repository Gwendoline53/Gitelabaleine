 ...
 */
final class Version20250731125715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenu (id INT AUTO_INCREMENT NOT NULL, cle VARCHAR(100) NOT NULL, texte LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_89C2003F41401D17 (cle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, subject VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, from_email VARCHAR(255) NOT NULL, phone_number VARCHAR(20) DEFAULT NULL, received_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_read TINYINT(1) NOT NULL, admin_reply LONGTEXT DEFAULT NULL, category VARCHAR(100) DEFAULT NULL, INDEX IDX_B6BD307FB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
